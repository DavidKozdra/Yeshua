...
- Name: reading.spec.js >> Reader – verse numbers and display settings >> verse numbers are visible by default
- Location: tests/e2e/reading.spec.js:65:3
...
Locator: locator('.verse-num, sup').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.verse-num, sup').first()
