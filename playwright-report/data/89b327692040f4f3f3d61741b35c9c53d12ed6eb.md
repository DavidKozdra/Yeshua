...
- Name: layout.spec.js >> Layout – 404 >> unknown route shows 404 page with home link
- Location: tests/e2e/layout.spec.js:50:3
...
Locator: getByRole('heading', { name: /page not found/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /page not found/i })
