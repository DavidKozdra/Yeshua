...
- Name: reading.spec.js >> Reader – basic load >> loads /read and shows verse text
- Location: tests/e2e/reading.spec.js:4:3
...
Locator: locator('.verse, .reading-text, [class*="verse"]').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.verse, .reading-text, [class*="verse"]').first()
