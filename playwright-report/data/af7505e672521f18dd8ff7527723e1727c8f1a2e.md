...
- Name: reading.spec.js >> Reader – chapter navigation >> has previous and next chapter buttons
- Location: tests/e2e/reading.spec.js:19:3
...
Locator: getByRole('button', { name: /previous chapter|prev|←/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /previous chapter|prev|←/i }).first()
