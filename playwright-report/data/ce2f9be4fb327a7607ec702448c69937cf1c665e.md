...
- Name: search.spec.js >> Search page – empty / short query >> shows the "search the bible text" empty state with no query
- Location: tests/e2e/search.spec.js:31:3
...
Expected pattern: /search the bible text/i
Timeout: 5000ms
