...
- Name: settings.spec.js >> Settings – Accessibility tab >> Color Vision Support select has all four options
- Location: tests/e2e/settings.spec.js:181:3
...
Call log:
  - waiting for getByRole('tab', { name: 'Accessibility' })
