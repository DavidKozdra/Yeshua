...
- Name: layout.spec.js >> Layout – sidebar navigation >> active sidebar link matches the current route
- Location: tests/e2e/layout.spec.js:14:3
...
Locator: locator('nav.sidebar').getByRole('link', { name: /notes/i })
...
Call log:
  ...
  - waiting for locator('nav.sidebar').getByRole('link', { name: /notes/i })
