...
- Name: reading.spec.js >> Reader – basic load >> saves last-read position (Continue Reading shows on home)
- Location: tests/e2e/reading.spec.js:11:3
...
Call log:
  ...
  - waiting for locator('.continue-card')
