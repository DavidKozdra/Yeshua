...
- Name: translations.spec.js >> Translations / Library page >> Bible Translations tab lists known translations
- Location: tests/e2e/translations.spec.js:11:3
...
Call log:
  - waiting for getByRole('tab', { name: /bible translations/i })
