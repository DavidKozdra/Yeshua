...
- Name: search.spec.js >> Search page – full-text search >> returns results for a common phrase and shows match count
...
Locator: locator('.search-summary')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.search-summary')
