...
- Name: globalSearchBar.spec.js >> Global Search Bar >> jumps directly to the reader for a valid reference (Genesis 1)
- Location: tests/e2e/globalSearchBar.spec.js:27:3
