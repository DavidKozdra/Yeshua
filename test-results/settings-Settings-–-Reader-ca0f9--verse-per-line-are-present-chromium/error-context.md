...
- Name: settings.spec.js >> Settings – Reader tab >> toggles for verse numbers, Words of Christ in Red, and one-verse-per-line are present
- Location: tests/e2e/settings.spec.js:116:3
