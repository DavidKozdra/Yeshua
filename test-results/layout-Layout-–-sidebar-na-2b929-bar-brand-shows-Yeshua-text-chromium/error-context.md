...
- Name: layout.spec.js >> Layout – sidebar navigation >> sidebar brand shows "Yeshua" text
- Location: tests/e2e/layout.spec.js:20:3
...
Locator: locator('.brand-text')
Expected substring: "Yeshua"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.brand-text')
