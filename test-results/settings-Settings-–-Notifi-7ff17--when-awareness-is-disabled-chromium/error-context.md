...
- Name: settings.spec.js >> Settings – Notifications tab >> holy day list collapses when awareness is disabled
- Location: tests/e2e/settings.spec.js:239:3
...
Call log:
  - waiting for getByRole('tab', { name: 'Notifications' })
