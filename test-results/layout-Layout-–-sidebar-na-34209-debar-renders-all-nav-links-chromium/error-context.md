...
- Name: layout.spec.js >> Layout – sidebar navigation >> sidebar renders all nav links
- Location: tests/e2e/layout.spec.js:4:3
...
Locator: locator('nav.sidebar').getByRole('link', { name: /home/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav.sidebar').getByRole('link', { name: /home/i })
