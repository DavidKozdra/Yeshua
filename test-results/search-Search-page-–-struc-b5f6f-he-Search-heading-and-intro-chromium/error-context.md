...
- Name: search.spec.js >> Search page – structure >> shows the Search heading and intro
...
Locator: getByRole('heading', { name: 'Search', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Search', exact: true })
