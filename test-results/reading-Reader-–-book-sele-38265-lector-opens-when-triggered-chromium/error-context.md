...
- Name: reading.spec.js >> Reader – book selector >> book selector opens when triggered
- Location: tests/e2e/reading.spec.js:54:3
...
Call log:
  - waiting for getByRole('button', { name: /genesis|book selector|chapters/i }).first() to be visible
