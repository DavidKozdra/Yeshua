...
- Name: layout.spec.js >> Layout – skip link >> skip link is in the DOM
- Location: tests/e2e/layout.spec.js:41:3
...
Call log:
  ...
  - waiting for locator('a.skip-link')
