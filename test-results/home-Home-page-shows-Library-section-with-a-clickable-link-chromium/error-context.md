...
- Name: home.spec.js >> Home page >> shows Library section with a clickable link
- Location: tests/e2e/home.spec.js:37:3
...
Locator: getByRole('button', { name: /open library/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /open library/i })
