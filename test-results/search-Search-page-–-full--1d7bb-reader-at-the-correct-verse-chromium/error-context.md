...
- Name: search.spec.js >> Search page – full-text search >> clicking a result navigates to the reader at the correct verse
...
Call log:
  - waiting for locator('.search-result-card').first() to be visible
