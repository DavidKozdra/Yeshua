...
- Name: reading.spec.js >> Reader – chapter navigation >> previous chapter button goes back
- Location: tests/e2e/reading.spec.js:33:3
...
Call log:
  - waiting for getByRole('button', { name: /previous chapter|prev|←/i }).first() to be visible
