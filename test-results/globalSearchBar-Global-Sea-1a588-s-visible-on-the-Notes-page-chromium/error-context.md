...
- Name: globalSearchBar.spec.js >> Global Search Bar >> is visible on the Notes page
- Location: tests/e2e/globalSearchBar.spec.js:9:3
...
Locator: locator('.global-search-shell')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.global-search-shell')
