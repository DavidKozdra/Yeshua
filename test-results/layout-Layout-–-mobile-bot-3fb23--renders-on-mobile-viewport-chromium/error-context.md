...
- Name: layout.spec.js >> Layout – mobile bottom navigation >> bottom nav renders on mobile viewport
- Location: tests/e2e/layout.spec.js:27:3
...
Locator: locator('nav.bottom-nav')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav.bottom-nav')
