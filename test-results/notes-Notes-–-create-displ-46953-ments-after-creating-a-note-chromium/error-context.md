...
- Name: notes.spec.js >> Notes – create, display, edit, delete >> note stats counter increments after creating a note
- Location: tests/e2e/notes.spec.js:41:3
...
Call log:
  - waiting for locator('.notes-stat').first().locator('strong')
