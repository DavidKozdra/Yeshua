...
- Name: home.spec.js >> Home page >> shows Continue Reading section after visiting the reader
- Location: tests/e2e/home.spec.js:56:3
...
Call log:
  ...
  - waiting for locator('.verse').first()
